 ...
 *
 * Works when compiled for either 32-bit or 64-bit targets,
 * optimized for 64 bit. Canonical implementation of
 * Init/Update/Finalize for SHA-3 byte input.
 *
 * SHA3-256, SHA3-384, SHA-512 are implemented.
 * SHA-224 can easily be added.
 *
 */
#include <stdio.h>
#include <stdint.h>
