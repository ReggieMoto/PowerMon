...
void user_io_fsm_process_string(pwrmon_msg_t *msg)
{
	...
	{
	case user_io_state_logging:
		POWERMON_LOGGER(USER_IO, DEBUG, "Logging module/level change.\n", 0);
		cfg_logging_input(msg);
		user_io_fsm(user_io_input_logging_chg);
		break;
